...
class Postagem:
    def __init__(self,objeto:str, localidade:str,data:str):
        self.objeto= objeto
        self.localidade = localidade
   ...
   ###Valida o formato da data###
    ...
    def __repr__(self):
        return f"Postagem(Objeto='{self.objeto}', localidade='{self.localidade}', data='{self.data}')"
...
#Adicionar postagens
    def adicionar_postagem(self, objeto, localidade, data):
        if not all([objeto, localidade, data]): #verifica se todos os dados foram preenchidos
    ...
    def listar_postagens(self):
        if not self.postagens:
            ...
            for postagem in self.postagens:
                print(f"Objeto:{postagem.objeto} - {postagem.localidade}- {postagem.data}")
